...
class RegisterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        with(view) {
            ...
            emailEditTextRegistration = findViewById(R.id.email)
            usernameEditTextRegistration = findViewById(R.id.username)
            passwordEditTextRegistration = findViewById(R.id.password)
            nameEditTextRegistration = findViewById(R.id.name)
            lastnameEditTextRegistration = findViewById(R.id.lastname)
            phoneEditTextRegistration = findViewById(R.id.phone)
            usernameEditTextLogin = findViewById(R.id.username_login)
            passwordEditTextLogin = findViewById(R.id.password_login)
            loginTextView = findViewById(R.id.login)
            registrationInputLayout = findViewById(R.id.registration_ll)
            alreadyInfoLayout = findViewById(R.id.already_ll)
            havenInfoLayout = findViewById(R.id.havent_ll)
            loginInputLayout = findViewById(R.id.login_ll)
            backActionLayout = findViewById(R.id.back)
        }
